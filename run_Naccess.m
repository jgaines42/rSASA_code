...
%Remove extra files
x = strcat('rm ', {' '},'/Users/jennifergaines/Documents/SASA_paper/this_dipept.asa');
system(x{:});
x = strcat('rm ', {' '},'/Users/jennifergaines/Documents/SASA_paper/this_dipept.rsa');
system(x{:});
x = strcat('rm ', {' '},'/Users/jennifergaines/Documents/SASA_paper/this_dipept.log');
system(x{:});
